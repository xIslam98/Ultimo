...
export default class Accessories extends React.Component {
    constructor(props) {
        ...
        this.orderbyname = this
            .orderbyname
            .bind(this)
        this.select = this
            .select
            .bind(this)
        this.orderbyprice = this
            .orderbyprice
            .bind(this)
        this.price = this
            .price
                        ...
                        <div className="regroup-pdl">
                            <div className="lateral-bar">
                                ...
                                <div className="price-navbar">
                                    ...
                                    <div className="simple-flex-navbar">
                                        <i class="fas fa-caret-right"></i>
                                        <li className="price" onClick={(e) => this.price(0, 516.1616, e)}>$0()-$516.1616()</li>
                                    </div>
                                    <div className="simple-flex-navbar">
                                        <i class="fas fa-caret-right"></i>
                                        <li className="price" onClick={(e) => this.price(616.1616, 716.1616, e)}>$70.00()-$716.1616()</li>
                                    </div>
                                    <div className="simple-flex-navbar">
                                        <i class="fas fa-caret-right"></i >
                                        <li className="price" onClick={(e) => this.price(716.1616, 1000000, e)}>$160.00() and above</li>
                                    </div>
                                </div>
                                ...
                                <span className="section-line"></span>
                                <p className="custo-top">Custom CMS block displayed at the top of the left
                                    sidebar. Put your own content here.</p>
                            </div>
                            <div className="shirt-div">
                                ...
                                <div className="option-pdl">
                                    ...
                                    <div className="simple-flex">
                                        <p className="para-item-pdl">View as:
                                        </p>
                                                                            ...
                                                                            <div className="simple-flex-shirt">
                                                                                <div className="simple-relative">
                                                                                    ...
                                                                                    <i
                                                                                        ...
                                                                                        onClick={(e) => this.AddProductWish(e)}
                                                                                        data-set={index}></i>
