              ...
              <div className="back">
                  <div className="regroup-feature mobile">
                    ...
                    <ContentZoom zoomPercent={250}
                            largeImageUrl={this.state.data[16].submenu[dataindex[1]].image} class="cloud-zoom product-image-gallery"
                            imageUrl={this.state.data[16].submenu[dataindex[1]].image} class="cloud-zoom product-image-gallery"
                            contentHeight={357}
                            contentWidth={268} 
                            />
                      </div>
                      ...
                      <div className="Feature-sample-fashion">
                          <h2 className="feature-h2">{this.state.data[16].submenu[dataindex[1]].title}</h2>
                          <div className="align-stars">
                           ...
                           <div className="regroup2">
                             <div className="price">{this.state.data[16].submenu[dataindex[1]].price}$</div>
