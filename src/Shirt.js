            ...
            <div className="shirt-shop">
                <div className="regroup-pdl">
                    ...
                    <div className="price-navbar">
                        ...
                        <div className="simple-flex-navbar"><i class="fas fa-caret-right"></i><li className="price" onClick={(e)=>this.price(50,59.99,e)}>$50.00()-$59.99()</li></div>
                        <div className="simple-flex-navbar"><i class="fas fa-caret-right"></i><li className="price">$70.00()-$70.99()</li></div>
                        <div className="simple-flex-navbar"><i class="fas fa-caret-right"></i ><li className="price">$80.00() and above</li></div>
                    </div>
