  ...
  this.setState({data2: response.data});
    ...
    AddProductWish(e){
      if(sessionStorage.length>0){
       ...
       let exElementi = [
          { 
          id:this.state.data[9].submenu[s].id, 
          title:this.state.data[9].submenu[s].title,
          image:this.state.data[9].submenu[s].image,
          offer:this.state.data[9].submenu[s].offer,
          offer_price:this.state.data[9].submenu[s].offer_price,
          price:this.state.data[9].submenu[s].price,
          image2:this.state.data[9].submenu[s].image2 
          }
        ]
