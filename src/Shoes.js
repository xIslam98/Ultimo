...
export default class Shoes extends React.Component {
    ...
    orderbyname(){
        ...
        tempo = this.state.data[14].submenu.sort(this.dynamicSort('title'));
        tempo2[14].submenu=tempo;
        console.log(tempo2)
    ...
    orderbyprice(){  
        tempo2=this.state.data
        tempo = this.state.data[14].submenu.sort(this.dynamicSort('price'));
        tempo2[14].submenu=tempo;
        console.log(tempo2)
        this.setState({data: tempo2});
        console.log(this.state.data)
    ...
    price(PriceDefineStart,PriceDefineEnd,e){
        e.preventDefault()
        for(let i=0;i<this.state.data[14].submenu.length;i++){
            if((PriceDefineStart<this.state.data[14].submenu[i].price) && (PriceDefineEnd >this.state.data[14].submenu[i].price))
            tempo3.push(this.state.data[14].submenu[i])
        }
        tempo2=this.state.data
        tempo2[14].submenu=tempo3;
        console.log(tempo3);
        console.log(tempo2);
        this.setState({data: tempo2});
    }
            ...
            <div className="shirt-shop">
                <div className="regroup-pdl">
                    ...
                    <div className="price-navbar">
                        ...
                        <div className="simple-flex-navbar"><i class="fas fa-caret-right"></i ><li className="price" onClick={(e)=>this.price(79.99,1000000,e)}>$140.00() and above</li></div>
                    </div>
                    ...
                    <div className="option-pdl">
                            ...
                            ? <span className="adjust-list">
                                {  this.state.data[14].submenu.map((mater,index)=>{
                                    return(
                                        <div className="product-plp">
                                { this.state.data[14].submenu[index].offer  
                                ? 
                                <Link to={`/Feature-shoes?id=${index}`}>
                                    <div className="simple-flex-shirt">
                                
                                    <img className="img-slide2" src={this.state.data[14].submenu[index].image}></img>
                                    <span className="sticker-wrapper">
                                        ...
                                        <div className="img-0-slide">{this.state.data[14].submenu[index].title}</div> 
                                        <div className="simple-flex2">                           
                                        <span className="img-1-price">{this.state.data[14].submenu[index].price}$</span>
                                    <span className="img-2-offer">{this.state.data[14].submenu[index].offer_price}</span>
                                    <Link to={`/Feature-shoes?id=${index}`}><button className="hover-apparence">View Details</button></Link>
                                    </div>
                                        </Link> 
                                :
                                <Link to={`/Feature-shoes?id=${index}`}>
                                    ...
                                    <div className="img-0-slide">{this.state.data[14].submenu[index].title}</div>
                                    <div className="simple-flex2">
                                    <span className="img-0-slide">{this.state.data[14].submenu[index].price}$</span>
                                    <Link to={`/Feature-shoes?id=${index}`}><button className="hover-apparence">View Details</button></Link>
                                    </div>
                                    </Link> 
                    ...
                    <Link to={`/Feature-shoes?id=${index}`}>
                        ...
                        <div className="regroup-list">
                            ...
                            <Link to={`/Feature-shoes?id=${index}`}><button>View Details</button></Link>
                        </div>
                        <div className="simple-flex">
                        <span className="img-0-description">{this.state.data[14].submenu[index].description}$</span>
