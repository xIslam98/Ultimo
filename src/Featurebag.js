...
import RelatedShoes from './related-shoe';
...
export default class Feature extends React.Component {
    ...
    Addcart(e){
        if(sessionStorage.length>0){
         ...
         let exElementi = [
            { 
            id:this.state.data[15].submenu[dataindex[1]].id, 
            title:this.state.data[15].submenu[dataindex[1]].title,
            image:this.state.data[15].submenu[dataindex[1]].image,
            offer:this.state.data[15].submenu[dataindex[1]].offer,
            offer_price:this.state.data[15].submenu[dataindex[1]].offer_price,
            price:this.state.data[15].submenu[dataindex[1]].price,
            image2:this.state.data[15].submenu[dataindex[1]].image2 
            }
          ]
              ...
              <div className="back">
                  <div className="regroup-feature mobile">
                    ...
                    <ContentZoom zoomPercent={350}
                            largeImageUrl={this.state.data[15].submenu[dataindex[1]].image} class="cloud-zoom product-image-gallery"
                            imageUrl={this.state.data[15].submenu[dataindex[1]].image} class="cloud-zoom product-image-gallery"
                            contentHeight={357}
                            contentWidth={268} />
                      </div>
                      ...
                      <div className="Feature-sample-fashion">
                          <h2 className="feature-h2">{this.state.data[15].submenu[dataindex[1]].title}</h2>
                          <div className="align-stars">
                           ...
                           <div className="regroup2">
                             <div className="price">{this.state.data[15].submenu[dataindex[1]].price}$</div>
                      ...
                      <div className="company-feature">
                          <img className="img-company" src="http://ultimo.infortis-themes.com/demo/media/wysiwyg/infortis/brands/company.png"></img>
                          <ul>
